...
public Cursor getQueryData(String namTable, String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String orderBy) {
  return mDB.query(namTable, columns, selection, selectionArgs, groupBy, having, orderBy);
	  ...
	  public void addRecTMC(String name, int pgr, float price, byte vis, float tara, int data_ins, byte ok) {
  ...
  private class DBHelper extends SQLiteOpenHelper {
    ...
    // REFERENCES ostat(id_tmc) ON DELETE RESTRICT	
      db.execSQL("create table tmc ("
          ...
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,price,vis,ok,tara) VALUES(1,'0.5Л',1,1,0,1,0.5)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,price,vis,ok,tara) VALUES(2,'1Л',1,1,0,1,1)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,price,vis,ok,tara) VALUES(3,'1.5Л',1,1,0,1,1.5)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,price,vis,ok,tara) VALUES(4,'2Л',1,1,0,1,2)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,price,vis,ok,tara) VALUES(5,'2.5Л',1,1,0,1,2.5)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,price,vis,ok,tara) VALUES(6,'3Л',1,1,0,1,3)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,price,vis,ok,tara) VALUES(7,'СТАКАН',1,1,0,1,0.5)");
