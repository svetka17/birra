...
//{R.id.tv_Id_Ostat_oborotka, R.id., R.id.tv_Name_Oborotka,R.id.tv_Ted_Oborotka, R.id.tv_Kol_Nach_Oborotka,R.id.tv_Sum_Nach_Oborotka,R.id.tv_Price_Nach_Oborotka,
    ...
    case 1:
        ...
        cb.setText(((cursor.getInt(cursor.getColumnIndex("vis"))==1)?"ÄËß ÏÐÎÄÀÆÈ":""));
        ...
        cb.setText(((cursor.getInt(cursor.getColumnIndex("ok"))==1)?"ÒÀÐÀ":""));
        /*viewTreeObserver = cb.getViewTreeObserver(); 
        viewTreeObserver.addOnGlobalLayoutListener(new OnGlobalLayoutListener() { 
            @Override 
            public void onGlobalLayout() { 
        ...
        */
        ...
        tv.setText( ((cursor.getString(cursor.getColumnIndex("namepgr")).equals("-íåò-"))?"":cursor.getString(cursor.getColumnIndex("namepgr"))) );
        /*viewTreeObserver = tv.getViewTreeObserver(); 
        viewTreeObserver.addOnGlobalLayoutListener(new OnGlobalLayoutListener() { 
            @Override 
            public void onGlobalLayout() { 
    ...
    case 5:
        ...
        tv.setText( ((cursor.getString(cursor.getColumnIndex("pname")).equals("-íåò-"))?"":cursor.getString(cursor.getColumnIndex("pname"))) );
