...
public class ColorPicker extends Dialog implements SeekBar.OnSeekBarChangeListener {
    ...
    public ColorPicker(Activity activity,
        ...
        this.green = Color.GREEN;//assertColorValueInRange(green);
        this.blue = Color.BLUE;//assertColorValueInRange(blue);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hexCode = (TextView) findViewById(R.id.hexCode_);
    ...
    private void updateColorView(String input) {
        try {
            ...
            hexCode.setError("нет ресурсов"/*activity.getResources().getText(R.string.materialcolorpicker__errHex)*/);
        }
    }
