...
public class UserActivity extends FragmentActivity implements /*OnItemClickListener,*/ LoaderCallbacks<Cursor> {
//static int ww=0;
  ListView lvData;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    btnExit = (Button) findViewById(R.id.btnExitUser);
    ...
    int[] to = new int[] {R.id.tvIdUser, R.id.tvNameUser/*, R.id.tvDataInsPgr*/  };
    ...
    .setCamdiareListener(new CambiareListener() {
		...
		public void OnCambiare(int flag, long id) {
			if (flag==1) {
				...
				if (countT==0)      
				{*/
				MainActivity.db.delRec("user",id);
    ...
    MainActivity.setSizeFontMain((LinearLayout)findViewById(R.id.user_ll));
  }
  ...
  static class MyCursorLoader extends CursorLoader {
    ...
    public Cursor loadInBackground() {
    	...
    	Cursor cursor = db.getRawData (
    			"select TP._id as _id, TP.name as name, TP.password as password, TP.ok as ok, TP.admin as admin, TP.data_ins as data_ins "
    			        + "from user as TP "
