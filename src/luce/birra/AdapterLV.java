...
//	        });
    ...
    case 1:
        ...
        cb.setText(((cursor.getInt(cursor.getColumnIndex("vis"))==1)?"ƒ¿":"Õ≈“"));
        ...
        */
        ...
        tv.setText( ((cursor.getString(cursor.getColumnIndex("namepgr")).equals("-ÌÂÚ-"))?"":cursor.getString(cursor.getColumnIndex("namepgr"))) );
        /*viewTreeObserver = tv.getViewTreeObserver(); 
        viewTreeObserver.addOnGlobalLayoutListener(new OnGlobalLayoutListener() { 
            @Override 
            public void onGlobalLayout() { 
    ...
    case 5:
        ...
        tv.setText( ((cursor.getString(cursor.getColumnIndex("pname")).equals("-ÌÂÚ-"))?"":cursor.getString(cursor.getColumnIndex("pname"))) );
...
/*
    ...
    case 9: 
        ...
        cb.setText(((cursor.getInt(cursor.getColumnIndex("admin"))==1)?"ƒ¿":"Õ≈“"));
