...
row.createCell(7).setCellValue("ÑĞÅÄÍßß ÖÅÍÀ ÍÀ "+MainActivity.getStringData(dat1));
...
row.createCell(14).setCellValue("ÑĞÅÄÍßß ÖÅÍÀ ÍÀ "+MainActivity.getStringData(dat2));
...
row.createCell(10).setCellValue("ÊÅÃÀ");
row.createCell(11).setCellValue("ÍÅÄÎÑÒÀÒÊÈ");
row.createCell(12).setCellValue("ÈÇËÈØÊÈ");
