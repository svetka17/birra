...
row.createCell(5).setCellValue("ЕД.ИЗМ");
row.createCell(6).setCellValue("ПРОДАНО СУММА ЗА ПЕРИОД");
row.createCell(7).setCellValue("ПРОДАНО СУММА НАЛ");
row.createCell(8).setCellValue("ПРОДАНО СУММА БЕЗНАЛ");
row.createCell(9).setCellValue("ОСТАТОК НА "+Calendar.getInstance().get(Calendar.DATE)+"-"+(Calendar.getInstance().get(Calendar.MONTH)+1)+"-"+Calendar.getInstance().get(Calendar.YEAR));
row.createCell(10).setCellValue("СУММА СКИДКИ");
row.createCell(11).setCellValue("ЦЕНА ПРОДАЖИ");
row.createCell(12).setCellValue("КЕГА");
