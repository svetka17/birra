...
row.createCell(7).setCellValue("ОСТАТОК НА "+Calendar.getInstance().get(Calendar.DATE)+"-"+(Calendar.getInstance().get(Calendar.MONTH)+1)+"-"+Calendar.getInstance().get(Calendar.YEAR));
row.createCell(8).setCellValue("СУММА СКИДКИ");
row.createCell(9).setCellValue("ЦЕНА ПРОДАЖИ");
