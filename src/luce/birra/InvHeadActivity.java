        	        ...
        	        do {
                	    ...
                	    {//Log.d("MyLog", "add="+ib);
                	    	MainActivity.db.addRecINVENT(
                	    			...
                	    			cOst.getDouble(cOst.getColumnIndex("okol")), /*(double)0*//*cOst.getDouble(cOst.getColumnIndex("okol"))*/cOst.getDouble(cOst.getColumnIndex("okol"))==0?0:Double.NaN, cOst.getDouble(cOst.getColumnIndex("ikol_n")), cOst.getDouble(cOst.getColumnIndex("isum_n")), cOst.getDouble(cOst.getColumnIndex("pkol")), cOst.getDouble(cOst.getColumnIndex("psum")), 
