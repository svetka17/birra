        ...
        public void onClick(View v) {
    	   ...
    	   int countkeg=-1;    	    
    	    if (cOst.moveToFirst()) { 
        		...
        		showMessage("œ–»’Œƒ "+s+"  ŒÀ-¬Œ:"+tvKol.getText().toString()+" ÷≈Õ¿:"+tvPrice.getText().toString(),0);
        		tvPrim.setText("");
  			 ...
  			 else
  			 {
  	        	...
  	        	showMessage("œ–»’Œƒ »«Ã≈Õ≈Õ "+s+"  ŒÀ-¬Œ:"+tvKol.getText().toString()+" ÷≈Õ¿:"+tvPrice.getText().toString(), 0);
  				finish();
  			 }
