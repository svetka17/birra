  ...
  private class DBHelper extends SQLiteOpenHelper {
    ...
    // REFERENCES ostat(id_tmc) ON DELETE RESTRICT	
    	...
    	db.execSQL("create table tmc ("
          ...
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,ed,price,vis,ok,tara,pos) VALUES(1,'0.5Л',1,2,1,0,1,0.5,1)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,ed,price,vis,ok,tara,pos) VALUES(2,'1Л',1,2,1,0,1,1,2)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,ed,price,vis,ok,tara,pos) VALUES(3,'1.5Л',1,2,1,0,1,1.5,3)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,ed,price,vis,ok,tara,pos) VALUES(4,'2Л',1,2,1,0,1,2,4)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,ed,price,vis,ok,tara,pos) VALUES(5,'2.5Л',1,2,1,0,1,2.5,5)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,ed,price,vis,ok,tara,pos) VALUES(6,'3Л',1,2,1,0,1,3,6)");
          db.execSQL("INSERT or replace INTO tmc (_id,name,pgr,ed,price,vis,ok,tara,pos) VALUES(7,'СТАКАН',1,2,1,0,1,0.5,7)");
